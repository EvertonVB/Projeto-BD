package gui.telaPrincipalGerente;
...
public class ControllerTelaPrincipalGerente implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            VBox box = FXMLLoader.load(getClass().getResource("/gui/telaPrincipalGerente/menu/FXMLConteudoMenuHamburguer.fxml"));
            drawerMenu.setSidePane(box);
        } catch (IOException ex) {
            Logger.getLogger(ControllerTelaPrincipalGerente.class.getName()).log(Level.SEVERE, null, ex); // ControllerTelaPrincipal?
        }
